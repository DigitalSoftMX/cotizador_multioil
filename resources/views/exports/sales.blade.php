<table border="1">
    <thead>
        <tr>
            ...
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" rowspan="2" width="15" height="25">
        ...
        <tr>
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" width="12">{{ __('REGULAR') }}</td>
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" width="12">{{ __('PREMIUM') }}</td>
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" width="12">{{ __('DIÉSEL') }}</td>
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" width="12">{{ __('REGULAR') }}</td>
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" width="12">{{ __('PREMIUM') }}</td>
            <td style="font-weight:bold;color:#ffffff;vertical-align:center" align="center" bgcolor="#34495E" width="12">{{ __('DIESEL') }}</td>
        </tr>
    </thead>
    <tbody>
