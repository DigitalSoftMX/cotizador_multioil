@extends('layouts.app', ['activePage' => 'Usuarios', 'titlePage' => __('Perfil de usuario')])
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('app_name') ? ' has-danger' : '' }}">
                                            <input
                                                ...
                                                name="app_name" id="input-name" type="text"
                                                placeholder="{{ __('Apellido paterno') }}"
                                                value="{{ old('app_name', auth()->user()->app_name) }}" required="true"
                                                aria-required="true" />
                                            @if ($errors->has('app_name'))
                                                <span id="name-error" class="error text-danger"
                                                    for="input-name">{{ $errors->first('app_name') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('apm_name') ? ' has-danger' : '' }}">
                                            <input
                                                class="form-control{{ $errors->has('apm_name') ? ' is-invalid' : '' }}"
                                                name="apm_name" id="input-name" type="text"
                                                placeholder="{{ __('Apellido materno') }}"
                                                value="{{ old('apm_name', auth()->user()->apm_name) }}" required="true"
                                                aria-required="true" />
                                            @if ($errors->has('apm_name'))
                                                <span id="name-error" class="error text-danger"
                                                    for="input-name">{{ $errors->first('apm_name') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row justify-content-center">
                                    <label class="col-sm-2 col-form-label"
                                        for="input-password">{{ __('Nuevo Contraseña') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                            <input
                                                class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"
                                                name="password" id="input-password" type="password"
                                                placeholder="{{ __('Nuevo Contraseña') }}" value="" required />
                                ...
                                <div class="row justify-content-center">
                                    <label class="col-sm-2 col-form-label"
                                        for="input-password-confirmation">{{ __('Confirma nueva contraseña') }}</label>
                                    <div class="col-sm-7">
