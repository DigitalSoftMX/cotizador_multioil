        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('energo.store') }}" autocomplete="off" class="form-horizontal" method="post">
                            @csrf
                    		@method('post')
                            <div class="form-row mt-3">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select custom-select-sm" id="cotizador" name="energo_id">
                            ...
                            <div class="form-row mt-3">
                                <div class="form-group col">
                                    ...
                                    <input class="form-control" id="regular_sin" name="precio_regular" placeholder="0" type="text" value="0" disabled>
                                    </input>
                                </div>
                                <div class="form-group col">
                                    ...
                                    <input class="form-control" id="premium_sin" min="0" name="precio_premium" placeholder="0" type="text" value="0" disabled>
                                    </input>
                                </div>
                                <div class="form-group col">
                                    <label for="disel_sin">
