          ...
          <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('app_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('app_name') ? ' is-invalid' : '' }}" name="app_name" id="input-app_name" type="text" placeholder="{{ __('Name') }}" value="{{ old('app_name', $user->app_name) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('apm_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('apm_name') ? ' is-invalid' : '' }}" name="apm_name" id="input-app_name" type="text" placeholder="{{ __('Name') }}" value="{{ old('apm_name', $user->apm_name) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-password-confirmation">{{ __('Rol del usuario') }}</label>
                  <div class="form-group{{ $errors->has('rol') ? ' has-danger' : '' }} col-md-2">
                      <input type="hidden" name="rol_actual" value="{{ $user->roles[0]->id }}">
