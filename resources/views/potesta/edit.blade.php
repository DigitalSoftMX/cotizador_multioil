        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('potesta.update',$competicions->price_potesta[(count($competicions->price_potesta)) - 1]->id)}}" autocomplete="off"
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input class="form-control" id="regular_sin" name="precio_regular" placeholder="0"
                                        type="text"
                                        value="{{$competicions->price_potesta[(count($competicions->price_potesta)) - 1]->precio_regular}}" />
                                </div>
                                <div class="form-group col">
                                    ...
                                    <input class="form-control" id="regular_sin" name="precio_premium" placeholder="0"
                                        type="text"
                                        value="{{$competicions->price_potesta[(count($competicions->price_potesta)) - 1]->precio_premium}}" />
                                </div>
                                <div class="form-group col">
                                    <label for="disel_sin">
                                        Diesel
                                    ...
                                    <input class="form-control" id="disel_sin" name="precio_disel" placeholder="0"
                                        type="text"
                                        value="{{$competicions->price_potesta[(count($competicions->price_potesta)) - 1]->precio_disel}}" />
                                </div>
                            </div>
